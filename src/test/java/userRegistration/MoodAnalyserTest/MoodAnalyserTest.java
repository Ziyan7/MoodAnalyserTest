...
public class MoodAnalyserTest {
	...
	/*
	 * @Test //testing method to return sad message public void
	 * givenMessage_WhenSad_ShouldReturnSad() { MoodAnalyser moodAnalyser = new
	 * MoodAnalyser(); String message =
	 * moodAnalyser.analyseMood("This is Sad Message"); assertEquals("SAD",
	 * message); }
	 */
	@Test
